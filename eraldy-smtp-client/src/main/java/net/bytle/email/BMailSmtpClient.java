...
public class BMailSmtpClient {
  ...
  public URI toUri() {
    try {
      return UriEnhanced
        ...
        .addQueryProperty(BMailSmtpConnectionAttribute.TLS, Booleans.createFromObject(this.getStartTls().getEnableStartTls()).toString())
        .toUri();
  ...
  private BMailStartTls getStartTls() {
    // cannot be null value
    if (config.startTls == null) {
      return BMailStartTls.NONE;
    }
    return config.startTls;
  }
  ...
  public static class config {
    ...
    String username;
    String password;
    BMailStartTls startTls = BMailStartTls.NONE;
