 ...
 * Every attribute should be created with {@link AttributeNoEnumAbs}
 * so that the equality function works
 * <p>
 * Attribute and not property because the product is called `tabulify`
 * <p></p>
 *
 * Deprecated because trying to add structure to unstructured data is a lost of time
 * Use {@link Attribute} with an enum instead and utility function to validate/cast your value
 */
@Deprecated
public interface AttributeNoEnum<T> {
   ...
   * For sorting
   */
  int compareTo(AttributeNoEnum<T> o);
