...
import static net.bytle.niofs.http.HttpRequestAttributes.PASSWORD;
import static net.bytle.niofs.http.HttpRequestAttributes.USER;
...
public class HttpRequestPath implements Path {
  ...
  public Path relativize(Path other) {
    ...
    if (!other.isAbsolute()) {
      otherHttpPath = (HttpRequestPath) other.toAbsolutePath();
    } else {
      otherHttpPath = (HttpRequestPath) other;
    }
  ...
  public void setAttribute(String attribute, Object value) {
    HttpRequestAttribute<String> attributeObject;
    try {
      //noinspection unchecked
      attributeObject = (HttpRequestAttribute<String>) Casts.castToAttribute(attribute, HttpRequestAttributes.ALL);
      if (attributeObject.equals(USER)) {
        this.getFileSystem().setUser(value.toString());
        return;
      }
      if (attributeObject.equals(PASSWORD)) {
